...
#' Reference: https://cegh.net/article/S2213-3984(21)00139-1/fulltext
#'
#' @param m1 First set of measurements
#' @param m2 Second set of measurements
#'
#' @return Creates a Bland-Altman plot showing agreement between two measurement methods
#' @export
#'
#' @examples
#' \dontrun{
#' # Example usage with two measurement methods
#' method1 <- rnorm(50, mean = 10, sd = 2)
#' method2 <- method1 + rnorm(50, mean = 0, sd = 0.5)
#' ba_plot(method1, method2)
#' }
ba_plot <- function(m1, m2) {
  ...
  plot(
    ...
    col = scales::alpha('royalblue4', 0.4),
    pch = 19,
